...
DEFINE("DIR_MT", "/opt/apps/".SHORTCODE."/queue/tsel/mt/");
DEFINE("DIR_MT2", "/opt/apps/".SHORTCODE."/queue/tsel/mt2/");
DEFINE("DIR_LOG", "/opt/apps/".SHORTCODE."/log/tsel/");
DEFINE("DB_TBL1", "queue_tsel_mt");
DEFINE("DB_TBL2", "sms_out_tsel");
DEFINE("DB_TBLT", "tied_mo");
...
if (DO_SET_URL_PREFIX)
{
	$url_prefix["telkomsel_push_0"] = "http://202.3.219.2:9100/push/submit.jsp";
	$url_prefix["telkomsel_push_0"] = "http://202.3.219.3:9100/push/submit.jsp";

	$url_prefix["telkomsel_pull_0"] = ":8100/cp/submitSM.jsp";
	$url_prefix["telkomsel_pull_0"] = ":8100/cp/submitSM.jsp";
	$url_prefix["telkomsel_pull_0"] = ":8100/cp/submitSM.jsp";

	$url_prefix["telkomsel_pull_1"] = ":9100/wapcharge/wapCharge.jsp";
	$url_prefix["telkomsel_pull_1"] = ":9100/wapcharge/wapCharge.jsp";
	$url_prefix["telkomsel_pull_1"] = ":9100/wapcharge/wapCharge.jsp";

	$url_prefix["telkomsel_pull_2"] = ":8100/cp/smartmessaging/send.jsp";
	$url_prefix["telkomsel_pull_2"] = ":8100/cp/smartmessaging/send.jsp";
	$url_prefix["telkomsel_pull_2"] = ":8100/cp/smartmessaging/send.jsp";
}
if (DO_SET_OTHERS)
...
log_write($in_trxids, "  index", $in_operat."_".$in_dlvmtd."_".$in_smstyp);
log_write($in_trxids, "  prefix", $prefix);
...
if ($in_dlvmtd == "pull")
{
	...
	$SQL2 = "INSERT INTO ".DB_TBL1." (".join(",", $arrf).") SELECT ".join(",", $arrv)." FROM ".DB_TBLT." WHERE trxid = '".$in_trxids."' LIMIT 1";
}
else
{
