...
DEFINE("DIR_MO", "/opt/apps/".SHORTCODE."/queue/hutch/mo/");
DEFINE("DIR_IP", "/opt/apps/".SHORTCODE."/queue/hutch/ipaddr/");
DEFINE("DB_TBL1", "queue_hutc_mo");
...
$in_operat = isset($_GET["operator"]) ? $_GET["operator"] : "hutch";
