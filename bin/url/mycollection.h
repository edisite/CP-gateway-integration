...
class mycollection
{
	...
	private:
		...
		bool _put(string psKey, string psData1, string psData2, string psData3, string psData4, string psData5, string psData6, string psData7, string psData8, string psData9, string psData10);
		bool _read(string &psKey, string &psData1, string &psData2, string &psData3, string &psData4, string &psData5, string &psData6, string &psData7, string &psData8, string &psData9, string &psData10);
		bool _item(string psKey, string &psData1, string &psData2, string &psData3, string &psData4, string &psData5, string &psData6, string &psData7, string &psData8, string &psData9, string &psData10);
};
