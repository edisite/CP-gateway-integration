...
for($x=0;$x<=$beda[beda];$x++)
{
	...
	while($result=mysql_fetch_object($q))
	{
		...
		else if($result->sid=='676811') {$price = 16500;}
		else if($result->sid=='676810') {$price = 11000;}
		else if($result->sid=='676808') {$price = 5500;}
		else if($result->sid=='676806') {$price = 2200;}
		else if($result->sid=='676805') {$price = 2200;}
		else if($result->sid=='676803') {$price = 1100;}
